        ...
        void Start()
        {
            ...
            else
            {
                ...
                if (UserManager.UserMeInstance == null)
                {
                    ...
                    PhotonNetwork.Instantiate("Prefabs/" + UserDeviceManager.GetPrefabToSpawnWithDeviceUsed(playerPrefabPC, playerPrefabVR).name, new Vector3(-92.8f, 0.1f, 54.7f), Quaternion.identity);
                }
                else
                {
